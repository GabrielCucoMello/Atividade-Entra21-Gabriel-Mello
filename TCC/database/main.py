...
while contagem_pred < len(data_pred):
    cur.executemany('INSERT INTO PREDICAO_PARQUE (PREDICAO_DATA, PREDICAO_CHUVA, PREDICAO_FUNCIONARIOS, PREDICAO_CLIENTES) VALUES (?, ?, ?, ?)', predicao[contagem_pred: passos_pred])
    contagem_pred += 1
    passos_pred += 1
    cnx.commit()
