...
# funcionarios_final = list(zip(funcionarios, data_mult_funcionarios, GeraAtracaoId()))

# df = pd.DataFrame(clientes_final)
# df.to_csv('Clientes.csv', index=False, header=False)

# df2 = pd.DataFrame(clima_final)
# df2.to_csv('Clima.csv', header=False, index=False)

# df3 = pd.DataFrame(atracao_final)
# df3.to_csv('Atracoes.csv', index=False, header=False)

# df4 = pd.DataFrame(funcionarios_final)
# df4.to_csv('Funcionarios.csv', index=False, header=False)

# def EnviaDatabase():
#     # Envia todas tuplas para o database na nuvem
#     global contagem_clientes
#     global contagem_clima 
#     global contagem_atracao
#     global contagem_funcionarios
#     global passos_clientes
#     global passos_clima
#     global passos_atracao
#     global passos_funcionarios
